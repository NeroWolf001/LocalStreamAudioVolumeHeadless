...
namespace LocalAudioStreamVolumeHeadless
{
    public class LocalAudioStreamVolumeHeadless : NeosMod
    {
        ...
        private static ModConfigurationKey<bool> ENABLED = new ModConfigurationKey<bool>("Set user audio stream volume to 0 in hosted sessions.");

        public override void OnEngineInit()
        {
            LocalAudioStreamVolumeHeadless.config = base.GetConfiguration();
            LocalAudioStreamVolumeHeadless.config.Save(true);
